...
class PolynomialJUnit2 {
	
	Polynomial[] polynomials;
	ArrayList<Double> coefficient;
	ArrayList<Integer> exponent;
	static final int NUMBER_TEST_POLYNOMIALS = 20;
	
	public PolynomialJUnit2() {
		
		polynomials = new Polynomial[NUMBER_TEST_POLYNOMIALS];
		
		
		coefficient = new ArrayList<Double>(Arrays.asList(2.0, -3.0, 4.0, 1.0));
		exponent = new ArrayList<Integer>(Arrays.asList(4, 3, 1, 0));
		polynomials[0] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-2.0, 3.0, -4.0));
		exponent = new ArrayList<Integer>(Arrays.asList(4, 3, 1));
		polynomials[1] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(2.0));
		exponent = new ArrayList<Integer>(Arrays.asList(0));
		polynomials[2] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(3.0));
		exponent = new ArrayList<Integer>(Arrays.asList(0));
		polynomials[3] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(2.0, 3.0, 4.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 0));
		polynomials[4] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(4.0, 5.0, 6.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 0));
		polynomials[5] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(1.5, 2.0, 3.0, 4.0, 5.0));
		exponent = new ArrayList<Integer>(Arrays.asList(6, 5, 3, 2, 0));
		polynomials[6] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(4.0, 5.0, 6.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 2, 1));
		polynomials[7] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-2.0, -3.0, -4.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 0));
		polynomials[8] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-4.0, -5.0, -6.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 0));
		polynomials[9] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-1.5, -2.0, -3.0, -4.0, -5.0));
		exponent = new ArrayList<Integer>(Arrays.asList(6, 5, 3, 2, 0));
		polynomials[10] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-4.0, -5.0, -6.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 2, 1));
		polynomials[11] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-2.0, -3.0, -4.0, -5.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 2, 0));
		polynomials[12] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(4.0, 5.0, -6.0, 7.0));
		exponent = new ArrayList<Integer>(Arrays.asList(5, 3, 2, 0));
		polynomials[13] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(-2.0, 3.0, -4.0, 5.0));
		exponent = new ArrayList<Integer>(Arrays.asList(6, 3, 2, 0));
		polynomials[14] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(4.0, -5.0, -6.0, 7.0, -10.0));
		exponent = new ArrayList<Integer>(Arrays.asList(7, 5, 3, 2, 0));
		polynomials[15] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(4.0, -5.0));
		exponent = new ArrayList<Integer>(Arrays.asList(1, 0));
		polynomials[16] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(1.0, -1.0));
		exponent = new ArrayList<Integer>(Arrays.asList(1, 0));
		polynomials[17] = new Polynomial(coefficient, exponent);

		coefficient = new ArrayList<Double>(Arrays.asList(1.0, 1.0));
		exponent = new ArrayList<Integer>(Arrays.asList(1, 0));
		polynomials[18] = new Polynomial(coefficient, exponent);
	...
	public void exceptionTest() { 
		coefficient = new ArrayList<Double>(Arrays.asList(1.0, 1.0, 1.0));
		exponent = new ArrayList<Integer>(Arrays.asList(1, 0));
		assertThrows(Exception.class, () -> { new Polynomial(coefficient, exponent); });
	}
